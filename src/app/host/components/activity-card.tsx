    ...
    <Card variant="interactive" className="flex flex-col">
      <CardHeader className="flex flex-row items-start justify-between p-4 pb-3">
        ...
        <div className='flex items-center gap-1'>
          <Button asChild variant="ghost" size="icon" title="Edit activity" className="h-8 w-8 hover:bg-muted rounded-lg">
          ...
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button variant="ghost" size="icon" title="Delete activity" className="h-8 w-8 hover:bg-muted rounded-lg">
