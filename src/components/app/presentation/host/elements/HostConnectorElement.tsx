...
interface HostConnectorElementProps {
  element: SlideElement;
}

export function HostConnectorElement({ element }: HostConnectorElementProps) {
  ...
  const markerId = `host-arrow-${element.id}`;
  const markerStartId = `host-arrow-start-${element.id}`;
